...
chai.use(require('chai-bn')(BN));
  ...
  describe('Mumbai HighWei Integration Test', async function () {
    it('Chainlink API and Prciefeed return > 0.', async () => {
      ...
      const highWeiContract = new ethers.Contract('0x18d5112C6602E5a4bAdFe75dA4ec223379EA2404', HighWeiKeeperABI, signer)
      const linkTokenContract = new ethers.Contract('0x326C977E6efc84E512bB9C30f76E30c160eD06FB', LinkTokenABI, signer)
      const transferTransaction = await linkTokenContract.transfer('0x18d5112C6602E5a4bAdFe75dA4ec223379EA2404','1000000000000000000')
      ...
      const resultServoState = await highWeiContract.timeOpened()
